...
| Dash Survivors | Este juego es 2D y consta en que eres Lobotomy de geometry dash y vienen los demons a por ti, para poder sobrevivir tendras que eliminar el maximo de demons posible. Para poder jugar a este juego se tiene que descargar toda la carpeta dependiendo del sistema operativo y descomprimir ambos archivos en una misma carpeta para que el juego pueda funcionar correctamente. |
